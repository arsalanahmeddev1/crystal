    ...
    <div class="container">
        <div class="contact-container">
            <div class="contact-info">
                <h4 class="bold-heading pb-0">Contact details</h4>
                ...
                <ul class="social-icons flex items-center gap-[20px] ml-5 mt-10 mb-[20px] lg:mb-0">
                ...
                <form id="appointment-form" class="font-semibold">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            <input type="text" id="full-name" placeholder="Your Name" class="w-full p-3 bg-gray-200 rounded-full border-none focus:outline-none text-black placeholder-black">
                        </div>
                        <div class="col-span-2">
                            <input type="text" id="email" placeholder="Email Address" class="w-full p-3 bg-gray-200 rounded-full border-none focus:outline-none text-black placeholder-black">
                        </div>
                        <div class="col-span-2">
                            <input type="tel" id="phone-no" placeholder="Phone No" class="w-full p-3 bg-gray-200 rounded-full border-none focus:outline-none text-black
                            placeholder-black">
                        </div>
                        <div class="col-span-2">
                            <select id="services" class="w-full p-3 bg-gray-200 rounded-full border-none focus:outline-none text-black appearance-none">
