<div class="dental-info-cards">
  <div class="card-light dental-info-card bg-grey">
      ...
      <a href="./class-schedule" class="uppercase font-bold text-[16px] rounded-anchor block w-fit">click
          here</a>
  </div>
  <div class="card-light dental-info-card bg-grey">
      <h5 class="hd-sm mb-3">Financial Options Available</h5>

      <a href="./contact" class="uppercase font-bold text-[16px] rounded-anchor block w-fit">click here</a>
  </div>
  <div class="card-light dental-info-card bg-grey">
