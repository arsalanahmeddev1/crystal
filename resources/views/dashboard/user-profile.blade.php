            ...
            <div class="user-image">
              <div class="avatar">
                <div class="common-align">
                  <div><img id="output" src="{{asset('assets/images/user/user-img.png')}}" alt="Profile Image">
                ...
                <div class="follow">
                  <div>
                    <div class="follow-num counter text-white" data-target="2586">2586</div><span>Follower</span>
                  </div>
                  <div>
                    <div class="follow-num counter text-white" data-target="6598">6598</div><span>Following</span>
                  </div>
                </div>
              </div>
            </div>
