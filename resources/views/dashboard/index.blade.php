                        ...
                        <div class="card widget-hover overflow-hidden">
                            ...
                            <div class="card-body pt-0 count-student">
                                <div class="school-wrapper">
                                    ...
                                    <div class="school-body"> <img src="{{ 'assets/images/dashboard-7/icon-2.svg' }}"
                                            alt="total teachers">
                                        <div class="right-line"><img src="{{ 'assets/images/dashboard-7/line.png' }}"
                                                alt="line"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card widget-hover overflow-hidden">
                            ...
                            <div class="card-body pt-0 count-student">
                                <div class="school-wrapper">
                                    ...
                                    <div class="school-body"> <img src="{{ 'assets/images/dashboard-7/icon1.svg' }}"
                                            alt="total students">
                                        <div class="right-line"><img src="{{ 'assets/images/dashboard-7/line.png' }}"
                                                alt="line"></div>
                                    </div>
